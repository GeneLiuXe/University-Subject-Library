...
//     }
//     else printf("Rename: file %s not exists.\n",source);
//     delete directory;
//     return success;
// }
...
//     ASSERT(dirHdr->Allocate(freeMap, DirectoryFileSize)); //DirectoryFileSize=200, allocates 2 sectors for directory files
//     // Flush the bitmap and directory FileHeaders back to disk
//     // We need to do this before we can "Open" the file, since open
//     // reads the file header off of disk (and currently the disk has garbage
//     // on it!).
//     DEBUG('f', "Writing headers back to disk.\n");
//     //FreeMapSector=0, write freemap header to sector 0 
//     mapHdr->WriteBack(FreeMapSector);
//     //DirectorySector=1, write directory header to sector 1
//     dirHdr->WriteBack(DirectorySector); 
//     // OK to open the bitmap and directory files now 
//     // The file system operations assume these two files are left open 
//     // while Nachos is running.
...
//     // to hold the file data for the directory and bitmap.
//     DEBUG('f', "Writing bitmap and directory back to disk.\n");
//     // flush changes to disk directory->WriteBack(directoryFile);
//     freeMap->WriteBack(freeMapFile); 
